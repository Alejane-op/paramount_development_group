<?php
// adminAbout.php — CRUD for About page content
session_start();
    ...
    <?php if ($tab==='history'): ?>
      <div class="main-card">
        ...
        <form method="post">
          ...
          <div class="field">
            <label>20+ Years Title</label>
            <input name="h20t" value="<?= h($h20t) ?>">
          </div>
          <div class="field">
            <label>20+ Years Body</label>
            <textarea name="h20b"><?= h($h20b) ?></textarea>
          </div>

          <div class="field">
            <label>15+ Years Title</label>
            <input name="h15t" value="<?= h($h15t) ?>">
          </div>
          <div class="field">
            <label>15+ Years Body</label>
