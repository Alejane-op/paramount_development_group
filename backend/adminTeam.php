...
function saveUploadedPhoto(?array $file): ?string {
  ...
  return '/uploads/' . $name; // Absolute web path
}
    ...
    <main class="admin-main">
      ...
      <div class="card">
        ...
        <form method="post" action="?action=save_header">
          ...
          <div class="actions"><button class="btn primary" type="submit">Save Header</button></div>
        </form>
      </div>
        ...
        <form method="post" action="?action=create" enctype="multipart/form-data">
          <div class="grid">
            ...
            <div>
              ...
              <div class="actions"><button class="btn primary" type="submit">Add Member</button></div>
            </div>
          </div>
        </form>
      </div>
