...
$userMail = $_SESSION['email'] ?? 'paramount_admin@example.com';
...
function save_image_upload(array $file): ?string {
  ...
  if (($file['size'] ?? 0) > 8*1024*1024) return null; // 8MB max
  ...
  return '/uploads/'.$name; // public path
}
