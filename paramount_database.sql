...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 19, 2025 at 10:17 AM
...
(3, 1, 'LukeWood Project', '<p>At Paramount Development Group, we believe development should serve more than investors—it should serve the community. Strong communities are built through intentional investment in both people and place. That’s why we actively engage with local organizations, civic leaders, and nonprofits to ensure our projects support broader community goals.<br>From workforce housing that keeps talent local, to mixed-use developments that create vibrant hubs of activity, we are committed to building projects that address real needs and generate lasting value. Beyond the buildings, we support initiatives that strengthen community infrastructure, youth development, and quality of life—because true progress comes when development and community move forward together.<br>We believe strong communities are built with intention. By aligning development with the needs of residents, employers, and investors, Paramount Development Group creates projects that not only perform financially but also enrich the fabric of the community. For us, success is measured in more than numbers—it’s measured in the strength, stability, and pride of the communities we help shape.</p>', '/uploads/blog_1758274280_4d67f432.jpeg', 0, 1, '2025-09-19 09:31:20', '2025-09-19 09:44:02');
...
('blogs_hero_p', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `avatar` varchar(255) DEFAULT 'asset/img/avatar.jpg',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(1, 'Paramount Development Group', 'paramount_admin@example.com', '$2y$12$khFxIUJc6V2UogyVvw9VSu1eQKyFFY6Zw6Cvjd5X8oF7sF7WkoPbC', '/uploads/user1.png', '2025-09-17 03:00:34', '2025-09-17 05:05:38', NULL, NULL);
